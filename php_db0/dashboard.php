        ...
        <div class="container text-center">
            <div class="row align-items-start">
                <div class="col col-sm-12 col-md-12 col-lg-2  ">
                    <img src="logo/logo.png" width="190" alt="" class="my-1">
                </div>
                <div class="col col col-sm-10 col-md-9 col-lg-8  ">
                ...
                <div class="col col col-sm-2 col-md-3 col-lg-2  log-in-back my-2">

                    <div class="login-button">
                   <a href="logout2.php"><button> <i class="fa-regular fa-user"></i> <span><?php echo $_SESSION['username']; ?></span> </button></a> 
                    </div>
